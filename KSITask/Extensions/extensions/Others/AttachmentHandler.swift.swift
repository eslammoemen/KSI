...
class AttachmentHandler: NSObject {
    ...
    func actionSheet(with attachmentMenu: AttachmentMenu) {
        ...
        if self.actionSheetController == nil {
            self.actionSheetController = UIAlertController(title: "Select Option", message: "", preferredStyle: .actionSheet)
        ...
        case .camera:
            ...
            let takePictureAction: UIAlertAction = UIAlertAction(title: "Camera", style: .default) { _ -> Void in
        ...
        case .photoLibrary:
            ...
            let choosePictureAction: UIAlertAction = UIAlertAction(title: "Photo Library", style: .default) { _ -> Void in
        ...
        case .video:
            ...
            let chooseVideoAction: UIAlertAction = UIAlertAction(title: "Record Video", style: .default) { _ -> Void in
        ...
        case .document:
            ...
            let chooseFileAction: UIAlertAction = UIAlertAction(title: "PDF File", style: .default) { _ -> Void in
                self.documentPicker()
            }
...
//        currentVC.showAlert("Not right", okButtonText: "Ok", cancelButtonText: "Cancel", position: .bottom) { (_, button) in
//            if button == .other {
