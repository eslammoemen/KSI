...
public final class DoubledSlider: UIControl, ViewProgrammatically {
    ...
    private func setupTrack() {
        ...
        self.track.backgroundColor = UIColor.systemGray6
        self.track.clipsToBounds = true
    }

    private func setupActiveTrack() {
        self.activeTrack.backgroundColor = UIColor.black
    }
    ...
    private lazy var leftThumbConstraint: NSLayoutConstraint = {
        return self.leftThumb.leadingAnchor.constraint(greaterThanOrEqualTo: self.track.leadingAnchor,constant:0)
    }()

    private lazy var rightThumbConstraint: NSLayoutConstraint = {
        return self.rightThumb.trailingAnchor.constraint(lessThanOrEqualTo: self.track.trailingAnchor,constant:0)
    }()
